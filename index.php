<?php
 $data = [
   [
      'question' => "Come state implementando la recente decisione della Corte di giustizia dell'Unione europea (CGUE) relativa al diritto all'oblio? <br>",
    ...
    <header>
      <div class="container-fluid"></div>
        <div class="row topbar d-flex">
          <div class="col header_sx d-flex align-items-center">
            <img src="search.png" alt="google_logo">
            <span>Privacy e Termini</span>
          </div>
          <div class="col header_dx d-flex justify-content-end align-items-center">
            <i class="fas fa-th"></i>
        ...
        <div class="row navbar">
          <ul class="list-unstyled list-inline">
            <li class="list-inline-item"><a href="#">Introduzione</a></li>
            <li class="list-inline-item"><a href="#">Norme sulla privacy</a></li>
            <li class="list-inline-item"><a href="#">Termini di servizio</a></li>
            <li class="list-inline-item"><a href="#">Tecnologie</a> </li>
            <li class="list-inline-item"><a href="#">Domande Frequenti</a> <div></div></li>
          </ul>
        </div>
      </div>
    </header>
    <main>
      <div class="container">
        ...
        foreach($data as $post => $k){
          echo('<h4 style="margin-top: 100px; color: black;">' . $k['question'] . '</h4>' . $k['answer'] );
        }
        ?>
      </div>
    </main>
